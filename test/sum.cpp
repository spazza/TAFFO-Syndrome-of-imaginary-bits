...
/**
 *  Test to assess the correct summation between two fixed_point_t, both + and += operators are tested.
 */
...
/**
 *  Test the correct summation of normal_fixed_point.
 */
BOOST_TEST_DECORATOR(*utf::description("Test the correct summation of the normal_fixed_point_t"))
BOOST_DATA_TEST_CASE(Normal_fixed_point_sum, normal_int ^ normal_frac, INT, FRAC) {
...
/**
 *  Test the correct summation of high_fixed_point.
 */
BOOST_TEST_DECORATOR(*utf::description("Test the correct summation of the high_fixed_point_t"))
BOOST_DATA_TEST_CASE(High_fixed_point_sum, high_int ^ high_out, INT, OUT) {
...
/**
 *  Test the correct summation of low_fixed_point.
 */
BOOST_TEST_DECORATOR(*utf::description("Test the correct summation of the low_fixed_point_t"))
BOOST_DATA_TEST_CASE(Low_fixed_point_sum, low_frac ^ low_out, FRAC, OUT) {
