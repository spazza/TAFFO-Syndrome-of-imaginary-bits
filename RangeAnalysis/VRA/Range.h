...
namespace std {
	template< class T, class U > std::shared_ptr<T> dynamic_ptr_cast( const std::shared_ptr<U>& r ) noexcept {
	...
	template< class T, class U > std::shared_ptr<T> dynamic_ptr_cast_or_null( const std::shared_ptr<U>& r ) noexcept {
  	...
  	template< class T, class U > std::shared_ptr<T> static_ptr_cast( const std::shared_ptr<U>& r ) noexcept {
	...
	template< class T, class U > bool isa_ptr( const std::shared_ptr<U>& r ) noexcept
	{
