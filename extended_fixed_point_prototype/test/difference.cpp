...
/**
 * Test to verify the correctness of the diffrence operation with all the possible representations.
...
BOOST_AUTO_TEST_SUITE(Difference_test)

// Difference with INT_BITS >= 0 and FRAC_BITS >= 0 - Integer values
...
BOOST_DATA_TEST_CASE(Different_integer_same_type, bdata::make(int_test_array_1) ^ bdata::make(int_test_array_2), v1, v2) {
...
// Difference with INT_BITS >= 0 and FRAC_BITS >= 0 - Floating point values
...
BOOST_DATA_TEST_CASE(Difference_float_same_type, bdata::make(float_test_array_1) ^ bdata::make(float_test_array_2), v1, v2) {
    const float TOLERANCE = 1e-9;
    extended_fixed_point_t<16,42> num1(v1);
    extended_fixed_point_t<16,42> num2(v2);
    extended_fixed_point_t<16,42> res1;

    extended_fixed_point_t<16,42> num3(v1);
    extended_fixed_point_t<16,42> num4(v2);
    extended_fixed_point_t<16,42> res2;

    extended_fixed_point_t<32,42> num5(v1);
    extended_fixed_point_t<32,42> num6(v2);
    extended_fixed_point_t<32,42> res3;
...
const int32_t high_int_test_array_1[] = { // Corner case
                                          0, 261888,
                                          // Random values
                                          13568, 9728, 199168, 109056, 152320, 208896, 245504, 64256, 9984, 52480,
                                          // Random negative values
...
const int32_t high_int_test_array_2[] = { // Corner case
                                          261888, 0,
                                          // Random values
                                          8448, 11520, 2560, 9984, 3840, 14848, 768, 4352, 14336, 13568,
                                          // Random negative values
                                          -2304, -4352, -1024, -768, -512, -4096, -7424, -1792, -2816, -7936};

BOOST_DATA_TEST_CASE(Difference_high_integer_same_type, bdata::make(high_int_test_array_1) ^ bdata::make(high_int_test_array_2), v1, v2) {
...
BOOST_DATA_TEST_CASE(Difference_low_float_same_type, bdata::make(low_float_test_array_1) ^ bdata::make(low_float_test_array_2), v1, v2) {
    const float TOLERANCE = 1e-9;
...
// Difference between a number with INT_BITS >= 0, FRAC_BITS >= 0 and another with INT_BITS >= 0, FRAC_BITS >= 0 - Integer values
...
BOOST_DATA_TEST_CASE(Difference_integer_different_type, bdata::make(different_type_int_test_array_1) ^ bdata::make(different_type_int_test_array_2), v1, v2) {
...
// Difference between a number with INT_BITS >= 0, FRAC_BITS >= 0 and another with INT_BITS >= 0, FRAC_BITS >= 0 - Floating point values
...
BOOST_DATA_TEST_CASE(Difference_float_different_type, bdata::make(different_type_float_test_array_1) ^ bdata::make(different_type_float_test_array_2), v1, v2) {
    const float TOLERANCE = 1e-9;
...
BOOST_DATA_TEST_CASE(Difference_high_integer_different_type, bdata::make(different_type_high_integer_test_array_1) ^ bdata::make(different_type_high_integer_test_array_2), v1, v2) {
    extended_fixed_point_t<16, -4> num1(v1);
    extended_fixed_point_t<16, -8> num2(v2);
    extended_fixed_point_t<16, -8> res1;
...
BOOST_DATA_TEST_CASE(Difference_low_float_different_type, bdata::make(different_type_low_float_test_array_1) ^ bdata::make(different_type_low_float_test_array_2), v1, v2) {
    const float TOLERANCE = 1e-9;
...
BOOST_DATA_TEST_CASE(Difference_high_integer_and_normal_different_type, bdata::make(different_type_high_integer_test_array_1) ^ bdata::make(different_type_high_integer_test_array_2), v1, v2) {
...
// Using previous values as input for the test
/*
BOOST_DATA_TEST_CASE(Difference_low_float_and_normal_different_type, bdata::make(different_type_low_float_test_array_1) ^ bdata::make(different_type_low_float_test_array_2), v1, v2) {
    const float TOLERANCE = 1e-9;
    extended_fixed_point_t<-4, 48> num1(v1);
