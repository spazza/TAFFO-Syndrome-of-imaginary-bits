...
typedef mpl::list<
    ...
    mpl::list<mpl::integral_c<int16_t, 3>, mpl::integral_c<int16_t, 5>>
...
typedef mpl::list<
    // Corner Cases
    mpl::list<mpl::integral_c<int16_t, 65>, mpl::integral_c<int16_t, 0>>,
    mpl::list<mpl::integral_c<int16_t, 0>, mpl::integral_c<int16_t, 65>>,
    mpl::list<mpl::integral_c<int16_t, 64>, mpl::integral_c<int16_t, 64>>,
    mpl::list<mpl::integral_c<int16_t, 128>, mpl::integral_c<int16_t, 0>>,
    //mpl::list<mpl::integral_c<int16_t, 0>, mpl::integral_c<int16_t, 128>>,
    mpl::list<mpl::integral_c<int16_t, 128>, mpl::integral_c<int16_t, -128>>,
    //mpl::list<mpl::integral_c<int16_t, -128>, mpl::integral_c<int16_t, 128>>,
    // Random values
